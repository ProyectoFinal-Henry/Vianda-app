    ...
    <div>
      ...
      <RowResponsive>
        <div className="flex flex-col mt-10 pb-4 items-center  w-full">
          <h1 className="font-extrabold text-2xl md:text-3xl ">Lista de Usuarios del sistema</h1>
        ...
        <div className="overflow-x-auto max-w-full">
          <table className="table ">
            ...
            <tbody>
              ...
              {Array.isArray(data) ? (
                data.map(({ id, rol, nombreCompleto, telefono, email, dni, direccion, activo, pedidos }, I) => {
                  return (
                    <tr
                      key={I}
                      className={`${I % 2 === 0 && `bg-accent/30`}  ${!activo && "bg-red-400/50"}`}
                    >
                      <td>{id}</td>
                      <td>
                        <div className="badge py-3 font-bold capitalize">{rol}</div>
                      </td>
                      ...
                      <td>{direccion}</td>
                      <td>
                        {activo ? <span className="text-neutral font-bold">Activo</span> : <span className="text-warning">Inactivo</span>}
                      </td>
                      ...
                      <td>
                        <div className=" h-full w-full flex flex-row  justify-center items-center gap-y-2 ">
                          ...
                          >
                            <EditCrud route={`/admin/usuarios/actualizar-usuario/${id}`} />
                          </span>
