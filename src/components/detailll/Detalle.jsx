    ...
    <>
      ...
      <dialog id="my_modal_3" className="modal  ">
            ...
            <div id="contenedorPrincipal">
              <div className=" flex flex-col items-center justify-center place-content-center">
                <div className="bg-accent/60 w-96 mt-4 py-1 rounded ">
                  <h1 className="text-center font-semibold tracking-wider">
                    Ravioles de verdura
                  </h1>
                </div>
                <div id="contenedorImg" className=" w-[28rem]">
              ...
              >
                <div className="flex flex-col gap-1">
                  <p className="bg-accent/30  pl-1 w-[6.5rem] rounded">
                    Descripcion
                  </p>
                  <p className=""> Ravioles de verdura con salsa blanca</p>
                </div>
                <div className="flex flex-col gap-1">
                  <p className="bg-accent/30 w-30 pl-1 w-28 rounded">
                    Ingredientes
                  </p>
        ...
        "
                ></div>
                <div className="flex flex-row gap-2">
                  <p className="bg-accent/30  pl-1 w-[3.8rem] rounded">
                    Precio:
                  </p>
              ...
              <div id="contenedorButton  " className="ml-80">
                <button className=" py-1  btn-accent bg-accent px-8 rounded-lg mt-3 ">
                  Agregar
                </button>
              </div>
            </div>
