        ...
        {data.map(
          ({
            ...
            return (
              ...
              md:max-w-[270px]  md:min-w-[270px]   shadow-xl cursor-default rounded-xl active:transform active:scale-105 active:shadow-md active:bg-amber-400 transform transition-transform hover:scale-110"
                scroll={false}
              >
                <figure>
                  <Image
